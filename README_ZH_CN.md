...
🔗 [下载最新版本](https://github.com/Lisir2002/Me-Bot/releases/latest)
...
特别感谢 [RikkaHub](https://github.com/re-ovo/rikkahub) 项目提供的 UI 设计灵感。MiniMe-Core 的界面设计深受 RikkaHub 优美且实用的设计启发。
